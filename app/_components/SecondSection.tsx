...
const [expanded, setExpanded] = useState(false);
  ...
  // We need to ensure the portal only renders on the client side
  useEffect(() => {
    setMounted(true);
  }, []);
  return (
    <section className="md:w-screen h-full w-full bg-black text-white px-4 md:px-12 pb-10">
      ...
      >
        <Image src={"/video-thumbnail.png"} className="object-cover" alt={"Logo"} fill />
      </motion.div>
        ...
        createPortal(
            ...
            {expanded && (
              <div className="fixed inset-0 z-[999] flex items-center justify-center">
                ...
                <motion.div
                  ...
                  className="relative w-[80vw] h-[80vh] bg-orange-400 rounded-2xl overflow-hidden z-10 shadow-2xl"
                >
                  <Image src={"/video-thumbnail.png"} className="object-cover" alt={"Logo"} fill />
                </motion.div>
          ...
          document.body
            ...
            <div className="flex flex-col gap-3 md:gap-5">
              ...
              <VideoDialog setExpanded={setExpanded}>
                <Button
                  size="icon"
                  onClick={()=>{setExpanded(true)}}
                  variant="outline"
